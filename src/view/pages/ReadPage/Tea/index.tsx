    ...
    return <AppTemplate nonavbar container={false}>
        ...
        <div className="mr-auto ml-auto" style={{ maxWidth: "650px", marginTop: "30px" }}>
            <Panel header={<b>KISS</b>} shaded bordered>
                小时候特别羡慕这里的男女主,这样的爱其实很美好(联系电影前后剧情)
            ...
            <Panel header={<b>未来的导向?</b>} shaded bordered collapsible>
                ...
                在可见的将来，在我完成本科阶段的学习后，就来宝宝附近的城市工作了。<br />
                届时，我们的爱定将更进一步。
            </Panel>
            ...
            <Panel header={<b>滑宝在性格上的问题</b>} shaded bordered collapsible>
                ...
                我为我明知自己的缺点而感到庆幸,正因如此我才有机会披荆斩棘在今天放弃昨天的道路,在明天实现今天的梦想。
                性格上的改进之路，往往是漫长的，但为了让李隐今后不会对我感到“厌倦”，我是下了决心去改变的。
            </Panel>
            ...
            <Panel header={<b>终相见</b>} shaded bordered>
                ...
                如果以5cm per second的速度行进，在我们相识的六年里，已经走过9460公里，也就是说，已经走过4个两千米。第一个两千千米，你爱上了我，第二个两千千米我们做出青涩的约定，第三个两千千米我们阔别许久，第四个两千千米，我们心的距离只有5厘米。我坚信，下一个两千千米时，我们身体的距离将不足一厘米，因为呀，我正在紧紧地抱着你
            </Panel>
            ...
            <Panel header={<b>距离和时间</b>} shaded bordered collapsible expanded={true}>
                ...
                距离与时间从来不是爱的阻隔,据调查非异地分手概率30%,而异地分手概率27%，从这个角度来讲，异地恋反而更加稳定。<br />
